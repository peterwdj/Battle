...
feature 'Allowing two players to enter their names' do
  scenario "Displays player one's names on screen after they have been entered" do
    visit '/'
  ...
  scenario "Displays player two's names on screen after they have been entered" do
    visit '/'
